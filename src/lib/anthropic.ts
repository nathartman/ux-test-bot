...
- NEVER generalize about "users" — write about what THIS participant did. Say "confused the participant" not "is confusing to users." Say "the participant couldn't find X" not "users may struggle to find X." Always say "the participant" or "the user" — never use their actual name, since engineers reading the ticket won't know who they are. Describe the specific incident, not a hypothetical pattern. Let the real behavior make the case — don't editorialize with general UX principles.
